...
test_result test_string_concat()
{
    char *cstr1 = "Hello";
    char *cstr2 = " World";
    ...
    bstd_string_result str_concat = bstd_string_concat(string1.value, string2.value);

    ASSERT(str_concat.ok);
    ASSERT_STR_EQ(concat_result, str_concat.value.data);

    return TEST_OK;
}

test_result test_string_concat_null()
{
    char *cstr1 = "Hello";
    char *cstr2 = " World";
